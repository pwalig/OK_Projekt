...
class KnapsackSolver{
    ...
    static PackagedSolution Ford_Bellman(const Problem & problem, Requirements requirements);
    static PackagedSolution Floyd(const Problem & problem, Requirements requirements);
};

class Floyd{
    public:
    static PackagedSolution Solve(const Problem & problem, Requirements requirements);
    static Solution Path(const Problem & problem);
};
